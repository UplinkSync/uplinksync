<?php
/**
 * UPLAA-247 Store: clean grid thumbs / watermarked enlarge (Option A)
 *
 * Migrated from database-resident Code Snippets row id=45 (DR-004 tranche 2).
 * scope: front-end   priority: 10
 *
 * Owner ded52157 Option A. Swaps 123 aerial products' small grid/browse thumbnails to the clean master attachment; single/enlarge/zoom keep the watermarked preview. Display-only, reversible by deactivating.
 *
